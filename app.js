...
(function(){
  ...
  // Navigation (also wired inline in index.html, this is a safe double-attach)
  const gotoBtn = qs('#gotoGenerator');
  if (gotoBtn) gotoBtn.addEventListener('click', ()=>{ qs('#landing').classList.add('hidden'); qs('#generator').classList.remove('hidden'); });
